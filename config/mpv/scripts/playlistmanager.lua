...
mp.add_key_binding("z", "sortplaylist", sortplaylist)
mp.add_key_binding("Z", "shuffleplaylist", shuffleplaylist)
mp.add_key_binding("ALT+z", "reverseplaylist", reverseplaylist)
